...
// @Title del
// @Description update object
// @Param   body		body 	[]controllers.DelTableRowsReq	true	     "parm"
// @Success 200
// @router /updateTableConfig [post]
func (f *TableManagerController) DelTableRows() {
	...
	//err = models.UpdateDBConfig(parmData.DB, parmData.TB)
	if err != nil {
		ReturnData.SetData(1, err.Error())
		return
	}
